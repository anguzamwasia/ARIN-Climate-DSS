  ...
  const filtered = docs.filter((d) => {
    ...
    if (activeSource === "National Reports") {
      if (!selectedMapCounty) {
          // If no county selected, only show national-level reports (country: 'Kenya')
          return d.country === "Kenya" && matchesSearch && matchesSource
      }
      ...
      <main className="container mx-auto px-4 lg:px-8 py-10">
        ...
        {loading ? (
          ...
          <div className="bg-white border border-border rounded-xl p-12 text-center text-muted-foreground text-sm shadow-sm">
            {activeSource === "National Reports" && !selectedMapCounty 
